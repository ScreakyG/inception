...
then
    ...
    wp core install --url=localhost --title="testinception" --admin_user=$WP_ADMIN_NAME --admin_password=$WP_ADMIN_PASS --admin_email=$WP_ADMIN_MAIL --allow-root #Installation de wordpress
